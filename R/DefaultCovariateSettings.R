...
createDefaultCovariateSettings <- function(excludedPreIndexCovariateConceptIds = c(),
  ...
  covariateSettings1 <- FeatureExtraction::createTemporalCovariateSettings(
    ...
    temporalStartDays = c(startDayWindow1, startDayWindow1+1),
    temporalEndDays = c(endDayWindow1, endDayWindow1),
  ...
  if (!(is.null(startDayWindow2))) {
    covariateSettings2 <- FeatureExtraction::createTemporalCovariateSettings(
      useConditionEraGroupStart = TRUE,
      useDrugEraGroupStart = TRUE,
      useProcedureOccurrence = TRUE,
      useDeviceExposure = TRUE,
      ...
      useVisitCount = TRUE,
      useVisitConceptCount = TRUE,
      temporalStartDays = c(startDayWindow2, startDayWindow2+1),
      temporalEndDays = c(endDayWindow2, endDayWindow2),
      includedCovariateConceptIds = c(includedCovariateConceptIds),
      addDescendantsToInclude = addDescendantsToExclude,
      excludedCovariateConceptIds = excludedCovariateConceptIds,
      addDescendantsToExclude = addDescendantsToExclude,
  ...
  if (!(is.null(startDayWindow3))) {
    covariateSettings3 <- FeatureExtraction::createTemporalCovariateSettings(
      useConditionEraGroupStart = TRUE,
      useDrugEraGroupStart = TRUE,
      useProcedureOccurrence = TRUE,
      useDeviceExposure = TRUE,
      ...
      useVisitCount = TRUE,
      useVisitConceptCount = TRUE,
      temporalStartDays = c(startDayWindow3, startDayWindow3+1),
      temporalEndDays = c(endDayWindow3, endDayWindow3),
      includedCovariateConceptIds = c(includedCovariateConceptIds),
      addDescendantsToInclude = addDescendantsToExclude,
      excludedCovariateConceptIds = excludedCovariateConceptIds,
      addDescendantsToExclude = addDescendantsToExclude,
  ...
  if (!(is.null(startDayWindow4))) {
    covariateSettings4 <- FeatureExtraction::createTemporalCovariateSettings(
      ...
      useVisitCount = TRUE,
      useVisitConceptCount = TRUE,
      temporalStartDays = c(startDayWindow4, startDayWindow4+1),
      temporalEndDays = c(endDayWindow4, endDayWindow4),
      includedCovariateConceptIds = c(includedCovariateConceptIds),
      addDescendantsToInclude = addDescendantsToExclude,
      excludedCovariateConceptIds = excludedCovariateConceptIds,
      addDescendantsToExclude = addDescendantsToExclude,
