...
testPhenotypeAlgorithm <- function(connectionDetails,
  ...
  if (!is.null(evaluationCohort$errorMessage)) {
    ...
    results <- tibble::tibble(cdm = cdmDatabaseSchema,
                              ...
                              sensitivity = sprintf("%0.3f", countsTable$sens),
                              sensitivityCi95Lb = sprintf("%0.3f ", countsTable$sensCi95Lb),
                              sensitivityCi95Ub = sprintf("%0.3f", countsTable$sensCi95Ub),
                              ppv = sprintf("%0.3f", countsTable$ppv),
                              ppvCi95Lb = sprintf("%0.3f", countsTable$ppvCi95Lb),
                              ppvCi95Ub = sprintf("%0.3f", countsTable$ppvCi95Ub),
                              specificity = sprintf("%0.3f", countsTable$spec),
                              specificityCi95Lb = sprintf("%0.3f", countsTable$specCi95Lb),
                              specificityCi95Ub = sprintf("%0.3f", countsTable$specCi95Ub),
                              npv = sprintf("%0.3f", countsTable$npv),
                              npvCi95Lb = sprintf("%0.3f", countsTable$npvCi95Lb),
                              npvCi95Ub = sprintf("%0.3f", countsTable$npvCi95Ub),
