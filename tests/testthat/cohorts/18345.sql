...
( 
  select concept_id from main.CONCEPT where concept_id in (1118084)
...
DELETE FROM main.cohort where cohort_definition_id = @cohort_definition_id;
INSERT INTO main.cohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select @cohort_definition_id as cohort_definition_id, person_id, start_date, end_date 
