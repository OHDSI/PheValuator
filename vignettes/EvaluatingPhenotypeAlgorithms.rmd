...
output:
  ...
  word_document:
    toc: yes
vignette: >
  %\VignetteIndexEntry{Creating a concept set using LLM}
...
The `Phenelope` package enables the creation of a concept set for a health condition that is translated into a JSON file that may be used directly or imported into ATLAS.
